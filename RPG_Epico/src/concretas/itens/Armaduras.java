        ...
        switch (esc) {
            case "20 -- 30,00 R$":
                if (((Heroi) p).getDinheiro() > 30) {
                    System.out.println("Você adquiriu uma armadura de nível 20% e gastou 30,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 30) + " R$.");
            ...
            case "40 -- 60,00 R$":
                if (((Heroi) p).getDinheiro() > 60) {
                    System.out.println("Você adquiriu uma armadura de nível 40% e gastou 60,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 60) + " R$.");
            ...
            case "60 -- 90.00 R$":
                if (p.getDinheiro() > 90) {
                    System.out.println("Você adquiriu uma armadura de nível 60% e gastou 90,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 90) + " R$.");
            ...
            case "80 -- 120,00 R$":
                if (p.getDinheiro() > 120) {
                    System.out.println("Você adquiriu uma armadura de nível 80% e gastou 120,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 120) + " R$.");
            ...
            case "100 -- 150,00 R$":
                if (p.getDinheiro() > 150) {
                    System.out.println("Você adquiriu uma armadura de nível 100% e gastou 150,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 150) + " R$.");
            ...
            case "escolha o nivel de Armadura":
                if (p.getDinheiro() > 150) {
                    System.out.println("Você adquiriu uma armadura de nível 200% e gastou 100,00 R$ seu dinheiro atual é: " + (((Heroi) p).getDinheiro()- 100) + " R$.");
